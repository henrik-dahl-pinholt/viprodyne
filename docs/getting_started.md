...
The returned `DatasetInferenceResult` contains posterior state probabilities,
Pol2 loading probabilities, predicted signal, fitted transition rates, fitted
loading rates, and contact-drive outputs when present.
